...
public final class DrawboardEndpoint extends Endpoint {
        ...
        room.invokeAndWait(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    log.error("MIZOUCHI " + "2402" + " " + "Unexpected exception: " + ex.toString(), ex);
                }
            }
        });
            ...
            room.invokeAndWait(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        log.error("MIZOUCHI " + "2403" + " " + "Unexpected exception: " + ex.toString(), ex);
                    }
                }
            });
        }
    ...
    public void onError(Session session, Throwable t) {
        ...
        if (root instanceof EOFException) {
            ...
            log.error("MIZOUCHI " + "2404" + " " + "onError: " + t.toString(), t);
        }
    }
            ...
            room.invokeAndWait(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        log.error("MIZOUCHI " + "2405" + " " + "Unexpected exception: " + ex.toString(), ex);
                    }
                }
            });
