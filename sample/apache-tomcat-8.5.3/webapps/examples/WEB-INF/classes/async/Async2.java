        ...
        Runnable run = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    log.info("MIZOUCHI " + "2397" + " " + "Putting AsyncThread to sleep");
                    Thread.sleep(2*1000);
                    log.info("MIZOUCHI " + "2398" + " " + "Writing data.");
                    ...
                    log.error("MIZOUCHI " + "2394" + " " + "Async2",x);
                }catch (IllegalStateException x) {
                    log.error("MIZOUCHI " + "2395" + " " + "Async2",x);
                }catch (IOException x) {
                    log.error("MIZOUCHI " + "2396" + " " + "Async2",x);
                }
            }
        };
